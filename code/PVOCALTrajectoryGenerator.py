...
# Read in data
data = pd.read_csv(r"C:\Users\vwgei\Documents\PVOCAL\data\ATOM.csv")
...
data = data.dropna(subset = "MMS_G_LAT")
data = data.dropna(subset = "MMS_G_LONG")
data = data.dropna(subset="MMS_G_ALT")
